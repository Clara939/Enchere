    ...
    void newLancerSetDemarrage() {
           jdbcTemplate.execute("IF OBJECT_ID('ENCHERES', 'U') IS NOT NULL DROP TABLE ENCHERES");
            ...
            jdbcTemplate.execute("create table Articles\n " +
                    ...
                    "            references Retraits,\n " +
                    "    id_acheteur         bigint,\n " +
                    " photo_article NVARCHAR(255) DEFAULT '/image/encheres_marteau.jpg'\n " +
                    ")");
            jdbcTemplate.execute("create table Encheres\n " +
                    "(\n " +
                    "    id_enchere      bigint identity\n " +
            ...
            articleRepository.create(new Article("VTT", "un peu cabossé", LocalDate.of(2026, 01, 01), LocalDate.of(2026, 02, 28), 250, null, "EN_VENTE", "/image/encheres_marteau.jpg", retraitRepository.readRetraitById(2), categorieRepository.readById(1), utilisateurDAO.readById(1), null));
            articleRepository.create((new Article("horloge", "plus d'excuses pour être en retard", LocalDate.of(2026, 3, 25), LocalDate.of(2026, 3, 30), 185, null, "CREE", "/image/encheres_marteau.jpg", retraitRepository.readRetraitById(2), categorieRepository.readById(3), utilisateurDAO.readById(2), null)));
            articleRepository.create(new Article("fauteuil", "bien moelleux", LocalDate.of(2026, 2, 01), LocalDate.of(2026, 02, 28), 300, null, "EN_VENTE", "/image/fauteuil_bleu.jpg", retraitRepository.readRetraitById(2), categorieRepository.readById(3), utilisateurDAO.readById(2), null));
